#2. Function calling - it is a statement that invokes or initiates the function.
# after defining functuon it does not get executed unless and until it is called.
