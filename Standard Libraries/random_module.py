#5. random module - this module is used to produce random values, this module is used to perform random action such as generating random number and orinting random number.
import random

# choice() - it return random value from given itterable
...
# randint() - this method is used to generate random integer between given range
